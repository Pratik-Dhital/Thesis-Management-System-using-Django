...
class ThesisGroup(models.Model):
    ...
    supervisor = models.ForeignKey(Lecturer,on_delete=models.CASCADE,limit_choices_to={'is_supervisor': True})
...
class Proposal(models.Model):
    group = models.ForeignKey('ThesisGroup', on_delete=models.CASCADE, related_name='proposals')
    ...
    reviewed_by_lecturer = models.ForeignKey(Lecturer,on_delete=models.SET_NULL,null=True,blank=True,related_name="lecturer_reviews")
...
class Thesis(models.Model):
    ...
    lecturer = models.ForeignKey(Lecturer,on_delete=models.CASCADE,related_name="reviewed_thesis")
    supervisor = models.ForeignKey(Lecturer,on_delete=models.CASCADE,related_name='supervised_thesis')
    status = models.ForeignKey(ThesisStatus,on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Defense(models.Model):
    ...
    scheduled_by = models.ForeignKey(Lecturer,on_delete=models.SET_NULL,null=True,blank=True)
